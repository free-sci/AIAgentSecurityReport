\begin{table}[htbp]
\centering
\caption{AI智能体主要安全漏洞（按严重级别降序、同等级发现日期倒序排列，2025--2026）}
...
\renewcommand{\arrayrulewidth}{0.45pt}

% 让 tabularx 的 X 列也变成 m 列，实现垂直居中
\renewcommand{\tabularxcolumn}[1]{m{#1}}

\begin{tabularx}{\textwidth}{
|>{\centering\arraybackslash}m{1.55cm}
|>{\raggedright\arraybackslash}m{2.05cm}
|>{\raggedright\arraybackslash}m{1.95cm}
...
2026-05-06 & OpenClaw OpenShell 沙箱文件写入 TOCTOU / symlink swap & OpenClaw $<$ 2026.4.22 & 9.6 & CVE-2026-44112 &
...
2026-04-29 & DocsGPT MCP test 绕过导致远程代码执行 & DocsGPT $\geq$ 0.15.0, $<$ 0.16.0 & 9.8 & CVE-2026-26015 &
\begin{itemize}[tabitem]
...
2026-04-21 & Flowise MCP stdio 命令注入 / allowlist 绕过 & Flowise / flowise-components $<$ 3.1.0 & 9.9 & CVE-2026-40933 &
\begin{itemize}[tabitem]
...
2026-04-15 & Upsonic MCP task 命令注入 & Upsonic 0.71.6 & 9.8 & CVE-2026-30625 &
\begin{itemize}[tabitem]
...
2026-04-07 & Langflow 未认证代码注入 / RCE & Langflow $<$ 1.3.0 & 9.8 & CVE-2025-3248 &
\begin{itemize}[tabitem]
...
2026-04-03 & PraisonAI Gateway 未授权 WebSocket / info 访问 & PraisonAI Gateway $<$ 4.5.97 & 9.1 & CVE-2026-34952 &
\begin{itemize}[tabitem]
...
2026-04-02 & Azure MCP Server 关键功能缺失认证 & Azure MCP Server / Azure Web Apps hosted service & 9.1 & CVE-2026-32211 &
\begin{itemize}[tabitem]
...
2026-01-12 & LibreChat MCP stdio 任意命令执行 & LibreChat $<$ v0.8.2-rc2 & 9.9 & CVE-2026-22252 &
\begin{itemize}[tabitem]
...
2025-12-23 & LangChain dumps/dumpd 序列化注入 & LangChain $<$ 0.3.81 and $<$ 1.2.5 & 9.3 & CVE-2025-68664 &
\begin{itemize}[tabitem]
...
2025-12-17 & MCP server git 复合漏洞 & Model Context Protocol Servers / \texttt{mcp-server-git} & 8.8 / 7.1 / 9.1 & CVE-2025-68143/4/5 &
\begin{itemize}[tabitem]
...
2025-09-22 & Flowise CustomMCP 远程代码执行 & Flowise 3.0.5 & 10.0 & CVE-2025-59528 &
\begin{itemize}[tabitem]
...
2025-07-09 & mcp-remote OAuth authorization endpoint 命令注入 & \texttt{mcp-remote} npm package 0.0.5--0.1.15 & 9.6 & CVE-2025-6514 &
\begin{itemize}[tabitem]
...
2025-06-13 & MCP Inspector 缺失认证导致远程代码执行 & MCP Inspector $<$ 0.14.1 & 9.4 & CVE-2025-49596 &
\begin{itemize}[tabitem]
...
2025-06-11 & EchoLeak / M365 Copilot AI command injection & Microsoft 365 Copilot & 9.3 & CVE-2025-32711 &
\begin{itemize}[tabitem]
...
2026-05-08 & PraisonAI legacy Flask API 默认禁用认证 & PraisonAI 2.5.6 to $<$ 4.6.34 & 7.3 & CVE-2026-44338 &
\begin{itemize}[tabitem]
...
2026-04-15 & Agent Zero External MCP Servers 远程代码执行 & Agent Zero 0.9.8 & 8.6 & CVE-2026-30624 &
\begin{itemize}[tabitem]
...
2026-04-15 & Windsurf Prompt Injection to MCP 配置命令执行 & Windsurf 1.9544.26 & 8.0 & CVE-2026-30615 &
\begin{itemize}[tabitem]
...
2026-03-30 & LangChain prompt loading 路径遍历 & LangChain / langchain-core $<$ 1.2.22 & 7.5 & CVE-2026-34070 &
\begin{itemize}[tabitem]
...
2026-01-09 & WeKnora MCP stdio 命令注入 & Tencent WeKnora $<$ 0.2.5 & 8.8 & CVE-2026-22688 &
\begin{itemize}[tabitem]
...
2025-11-07 & Open WebUI Direct Connections SSE 代码注入 & Open WebUI $<$ 0.6.35 & 8.0 & CVE-2025-64496 &
\begin{itemize}[tabitem]
