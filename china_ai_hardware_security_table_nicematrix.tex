...
\Block{3-1}{学术侧} &
\Block{3-1}{可信计算、vTPM 与云端信任链} &
\Block{3-1}{中科院、清华、上海交大、中科大、浙大、北航、国防科大等；SvTPM/CCxTrust 相关团队} &
...
\Block{3-1}{学术侧} &
\Block{3-1}{国产 NPU/GPU 大模型适配、量化与推理系统} &
\Block{3-1}{北航、清华、中科院计算所、华为/昇腾生态、国产 GPU/NPU 研究团队} &
...
\Block{3-1}{学术侧} &
\Block{3-1}{端侧/边缘 AI 芯片架构与本地私有推理} &
\Block{3-1}{中科院计算所、寒武纪相关团队、高校体系结构与边缘智能团队} &
...
\Block{3-1}{产业侧} &
\Block{3-1}{昇腾生态、国产 AI 软件栈与政企私有化部署} &
\Block{3-1}{华为昇腾、CANN、MindSpore、openEuler、鲲鹏/昇腾服务器、ModelArts/云管平台生态} &
...
\Block{3-1}{产业侧} &
\Block{3-1}{国产 CPU/AI 加速器协同与信创适配} &
\Block{3-1}{海光、飞腾、鲲鹏、龙芯；寒武纪、壁仞、沐曦、摩尔线程等 AI 芯片/GPU 厂商} &
国产 CPU 提供服务器信创底座。 &
...
\Block{3-1}{产业侧} &
\Block{3-1}{等保、密评、数据安全与生成式 AI 标准补齐} &
\Block{3-1}{国家标准委、TC260、密码管理部门、网信部门、测评机构、政企采购方} &
