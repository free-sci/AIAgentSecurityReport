...
\multirow[c]{3}{1.8cm}{\centering 机密计算、TEE 与云端 AI 隔离边界验证} &
\multirow[c]{3}{2.1cm}{ETH Zurich、TU Berlin、CISPA、KU Leuven、Cambridge、Imperial、EPFL 等系统安全团队} &
...
\hline
\multirow[c]{3}{0.9cm}{\centering 学术侧} &
\multirow[c]{3}{1.8cm}{\centering SEV-SNP、远程证明与平台初始化细节安全} &
\multirow[c]{3}{2.1cm}{ETH Zurich、CISPA、欧洲形式化方法与云安全团队；AMD PSIRT 协调披露生态} &
...
\hline
\multirow[c]{3}{0.9cm}{\centering 学术侧} &
\multirow[c]{3}{1.8cm}{\centering 工业边缘可信连接、设备证明与数据空间安全} &
\multirow[c]{3}{2.1cm}{Fraunhofer、Industrial Data Space/International Data Spaces 生态、欧洲嵌入式/IoT 安全团队} &
...
\multirow[c]{3}{1.8cm}{\centering 主权算力、合规 AI 与公共超算基础设施} &
\multirow[c]{3}{2.1cm}{European Commission、EuroHPC JU、成员国超算中心、AI Factories、JUPITER/LUMI/BSC 等生态} &
...
\hline
\multirow[c]{3}{0.9cm}{\centering 产业侧} &
\multirow[c]{3}{1.8cm}{\centering 工业、汽车与嵌入式安全芯片底座} &
\multirow[c]{3}{2.1cm}{Infineon、STMicroelectronics、NXP、Bosch、Siemens、Arm 欧洲生态} &
...
\hline
\multirow[c]{3}{0.9cm}{\centering 产业侧} &
\multirow[c]{3}{1.8cm}{\centering 工业现场安全运营、合规采购与长期维护} &
\multirow[c]{3}{2.1cm}{Siemens、Bosch Rexroth、Schneider Electric、工业软件厂商、ProductCERT/PSIRT 生态} &
...
\label{tab:europe-ai-hardware-security-formatted}
\end{table*}
