  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <div className="relative z-10 p-8 md:p-12 lg:p-16 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-[60vh]">
          <div className="w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 mb-8">
